<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ZWard6.aspx.cs" Inherits="GarbageMaster.Pages.ZWard6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../wwwroot/js/GeoJsonByWards/ward6.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-center">
        <asp:Label ID="lblAverage" runat="server" Text="Ward 6"></asp:Label>
    </div>
    ...
    <script>
        ...
        var map = L.map('map').setView([27.727, 85.355], 14);
        ...
        L.geoJSON(ward6JSON, {
            onEachFeature: function (feature, layer) {
                layer.bindPopup(function (layer) {
                    if (feature.properties.name == "Ward6") {
