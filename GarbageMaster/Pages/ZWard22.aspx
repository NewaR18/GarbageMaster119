<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ZWard22.aspx.cs" Inherits="GarbageMaster.Pages.ZWard22" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../wwwroot/js/GeoJsonByWards/ward22.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-center">
        <asp:Label ID="lblAverage" runat="server" Text="Ward 22"></asp:Label>
    </div>
    ...
    <script>
        ...
        var map = L.map('map').setView([27.702, 85.312], 15.5);
        ...
        L.geoJSON(ward22JSON, {
            onEachFeature: function (feature, layer) {
                layer.bindPopup(function (layer) {
                    if (feature.properties.name == "Ward22") {
