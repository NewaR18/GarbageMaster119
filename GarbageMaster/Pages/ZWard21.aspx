<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ZWard21.aspx.cs" Inherits="GarbageMaster.Pages.ZWard21" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../wwwroot/js/GeoJsonByWards/ward21.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-center">
        <asp:Label ID="lblAverage" runat="server" Text="Ward 21"></asp:Label>
    </div>
    ...
    <script>
        ...
        var map = L.map('map').setView([27.698, 85.308], 15.5);
        ...
        L.geoJSON(ward21JSON, {
            onEachFeature: function (feature, layer) {
                layer.bindPopup(function (layer) {
                    if (feature.properties.name == "Ward21") {
