...
{
    public partial class ZWard23 : System.Web.UI.Page
    {
        public DLL _dll;
        public BLL _bll;
        public ZWard23()
        ...
        {
            DataTable table = _dll.Extractwastewithwarddata(23);
        ...
        {
            _dll.setonfire(23);
            _bll.mailsend(Label23.Text, 23);
            Response.Redirect("ZWard23.aspx");
        }
    }
}