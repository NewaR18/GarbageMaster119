...
{
    public partial class ZWard22 : System.Web.UI.Page
    {
        public DLL _dll;
        public BLL _bll;
        public ZWard22()
        ...
        {
            DataTable table = _dll.Extractwastewithwarddata(22);
        ...
        {
            _dll.setonfire(22);
            _bll.mailsend(Label22.Text, 22);
            Response.Redirect("ZWard22.aspx");
        }
    }
}