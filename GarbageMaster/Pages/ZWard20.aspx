<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ZWard20.aspx.cs" Inherits="GarbageMaster.Pages.ZWard20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../wwwroot/js/GeoJsonByWards/ward20.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-center">
        <asp:Label ID="lblAverage" runat="server" Text="Ward 20"></asp:Label>
    </div>
    ...
    <script>
        ...
        var map = L.map('map').setView([27.704, 85.305], 15.5);
        ...
        L.geoJSON(ward20JSON, {
            onEachFeature: function (feature, layer) {
                layer.bindPopup(function (layer) {
                    if (feature.properties.name == "Ward20") {
